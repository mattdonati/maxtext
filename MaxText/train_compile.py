...
def get_shaped_inputs(topology_mesh, config):
  ...
  # Shaped state
  abstract_state, state_mesh_annotations, state_mesh_shardings = max_utils.get_abstract_state(model, tx, config, example_rng, topology_mesh)
  ...
  shaped_train_kwargs = {}
  return shaped_train_args, shaped_train_kwargs, state_mesh_annotations, state_mesh_shardings, model
...
def main(argv: Sequence[str]) -> None:
  ...
  # Get shaped inputs
  shaped_train_args, shaped_train_kwargs, state_mesh_annotations, state_mesh_shardings, model = get_shaped_inputs(topology_mesh, config)
