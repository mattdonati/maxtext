...
def get_functional_train_with_signature(train_step, mesh, state_mesh_shardings, model, config):
  ...
  functional_train = get_functional_train_step(train_step, model, config, mesh, state_mesh_shardings)
...
def get_functional_train_step(train_step, model, config, mesh, state_mesh_shardings):
  return functools.partial(train_step, model, config, mesh, state_mesh_shardings)
