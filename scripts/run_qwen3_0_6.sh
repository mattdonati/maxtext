...
export WORKLOAD_NAME="${WORKLOAD_NAME:-qwen3-0804-agentic}"
...
XPK_CMD=(
  ...
  --command="pip install git+https://github.com/AI-Hypercomputer/pathways-utils.git --no-deps; python3 scripts/patches/patch_rl_config.py; python3 scripts/patches/patch_train_rl.py; python3 src/dependencies/scripts/install_post_train_extra_deps.py; python3 scripts/patches/patch_tpu_inference_compiler_options.py; ${MAXTEXT_COMMAND}"
)
